...
export const createApp = (): Express => {
  ...
  app.use("/api/admin/safaricom_ceo/v1/sessions", safaricomCeoAdminSessionRoutes);
  app.use("/api/admin/safaricom_ceo/v1/analytics", safaricomCeoAdminAnalyticsRoutes);
