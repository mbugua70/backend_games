...
export const createGameConfig = asyncHandler(async (req: Request, res: Response): Promise<void> => {
...
export const getGameConfig = asyncHandler(async (req: Request, res: Response): Promise<void> => {
  const { eventId } = eventIdParamSchema.parse(req.params);
...
export const updateGameConfig = asyncHandler(async (req: Request, res: Response): Promise<void> => {
  const { eventId } = eventIdParamSchema.parse(req.params);
  const input = gameConfigSchema.parse(req.body);
